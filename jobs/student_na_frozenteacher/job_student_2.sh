...
#SBATCH --job-name=STARTUP_Student_2_ft
...
for target_testset in "CropDisease"; do
...
echo finish
cd $SLURM_TMPDIR
zip -r ~/scratch/student_STARTUP_$target_testset\_na_frozenteacher.zip $SLURM_TMPDIR/STARTUP/student_STARTUP_na/
