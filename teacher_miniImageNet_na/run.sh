...
# training a classification model with GroupNorm on miniImageNet
python train.py --dataset miniImageNet --model ResNet10_GN4  --method baseline --bsize 256 --start_epoch 0 --stop_epoch 400 --train_aug 
