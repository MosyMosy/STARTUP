...
#     zip -r ~/scratch/$target_testset\_na_frozenteacher.zip $SLURM_TMPDIR/STARTUP/student_STARTUP_na/miniImageNet_source/$target_testset\_unlabeled_20_frozenteacher
# done
